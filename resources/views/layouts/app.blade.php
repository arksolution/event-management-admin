...
<head>
    ...
    <base href="./">
    <!-- Bootstrap core CSS -->
    <link href="{{asset('public/css/assets/css/bootstrap.css')}}?key=<?php echo time()?>" rel="stylesheet">
    <!-- Custom styles -->
    <link href="{{asset('public/css/assets/css/custom.css')}}?key=<?php echo time()?>" rel="stylesheet">

    <script type="text/javascript" src="{{asset('public/js/Chart.min.js')}}?key=<?php echo time()?>"></script>

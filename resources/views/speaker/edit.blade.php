...
@section('content')
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form class="needs-validation" enctype="multipart/form-data" novalidate action="{{route('speaker.update', $speaker->id)}}" method="post">
                @method('PATCH')
                @csrf
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control {{$errors->first('info') ? 'is-invalid' : ''}}" id="inputSlug" name="info" placeholder="" rows="5">{{old('info') ?? $speaker->info}}</textarea>
                        <div class="invalid-feedback">
                            {{$errors->first('info')}}
                        </div>
                    </div>

...
(1, 1, 'WorldSkills Conference 2021', 'wsc-2021', '2021-09-23'),
...
--
-- Cấu trúc bảng cho bảng `event_ratings`
--
...
--
-- Cấu trúc bảng cho bảng `event_tickets`
--
...
--
-- Đang đổ dữ liệu cho bảng `event_tickets`
--
...
(1, '2020_04_23_011238_create__tables', 1),
(2, '2020_07_09_064640_create_speaker', 1),
(3, '2020_07_09_070851_create_speaker', 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `organizers`
--
...
--
-- Đang đổ dữ liệu cho bảng `organizers`
--

INSERT INTO `organizers` (`id`, `name`, `slug`, `email`, `password_hash`) VALUES
(1, 'Organizerdemo1', 'demo1', 'demo1@worldskills.org', '$2y$10$uzJDPSG0lW9Y8Aodb.k79.b6wcS64kjWqPFQsw9FOVqzW0S28qblC'),
(2, 'Organizerdemo2', 'demo2', 'demo2@worldskills.org', '$2y$10$ktCtwC.Hea2eX5wXLScC.OwkioTU75UIb3G1V5pAuHtJqWm1Xra2S');
...
--
-- Cấu trúc bảng cho bảng `session_ratings`
--
...
--
-- Cấu trúc bảng cho bảng `session_registrations`
--
...
--
-- Đang đổ dữ liệu cho bảng `session_registrations`
--
...
--
-- Cấu trúc bảng cho bảng `speaker_sessions`
--
...
--
-- Chỉ mục cho bảng `event_ratings`
--
ALTER TABLE `event_ratings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `event_ratings_event_id_foreign` (`event_id`),
  ADD KEY `event_ratings_attendee_id_foreign` (`attendee_id`);

--
-- Chỉ mục cho bảng `event_tickets`
--
...
--
-- Chỉ mục cho bảng `session_ratings`
--
ALTER TABLE `session_ratings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `session_ratings_session_id_foreign` (`session_id`),
  ADD KEY `session_ratings_attendee_id_foreign` (`attendee_id`);

--
-- Chỉ mục cho bảng `session_registrations`
--
...
--
-- Chỉ mục cho bảng `speaker_sessions`
--
ALTER TABLE `speaker_sessions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `speaker_sessions_speaker_id_foreign` (`speaker_id`),
  ADD KEY `speaker_sessions_session_id_foreign` (`session_id`);
...
--
-- AUTO_INCREMENT cho bảng `organizers`
--
ALTER TABLE `organizers`
...
--
-- AUTO_INCREMENT cho bảng `session_ratings`
--
ALTER TABLE `session_ratings`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `event_ratings`
--
ALTER TABLE `event_ratings`
  ADD CONSTRAINT `event_ratings_attendee_id_foreign` FOREIGN KEY (`attendee_id`) REFERENCES `attendees` (`id`),
  ADD CONSTRAINT `event_ratings_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`);

--
-- Các ràng buộc cho bảng `event_tickets`
--
ALTER TABLE `event_tickets`
...
--
-- Các ràng buộc cho bảng `session_ratings`
--
ALTER TABLE `session_ratings`
  ADD CONSTRAINT `session_ratings_attendee_id_foreign` FOREIGN KEY (`attendee_id`) REFERENCES `attendees` (`id`),
  ADD CONSTRAINT `session_ratings_session_id_foreign` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`);

--
-- Các ràng buộc cho bảng `session_registrations`
--
ALTER TABLE `session_registrations`
...
--
-- Các ràng buộc cho bảng `speaker_sessions`
--
ALTER TABLE `speaker_sessions`
  ADD CONSTRAINT `speaker_sessions_session_id_foreign` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`),
  ADD CONSTRAINT `speaker_sessions_speaker_id_foreign` FOREIGN KEY (`speaker_id`) REFERENCES `speakers` (`id`);
COMMIT;
